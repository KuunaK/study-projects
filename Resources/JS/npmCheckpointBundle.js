(() => {
  ...
  // myConfig.js
  var Keys = {
    myKey: "7a4a7470ede74b6a8a3352fdabb6f0fb"
  };
  var myConfig_default = Keys;
  ...
  var selectCountryBtn = document.getElementById("select-country-btn");
  var selectCountryContent = document.getElementById("select-country-content");
  var selectCountryApply = document.getElementById("select-country-apply");
  ...
  fetch(`https://api.geoapify.com/v1/ipinfo?apiKey=${myConfig_default.myKey}`).then((resp) => resp.json()).then((userLocationData) => {
